...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference("Exercicio.count") do
      post exercicios_url, params: { exercicio: { grupo_muscular: @exercicio.grupo_muscular, instrucoes: @exercicio.instrucoes, nome: @exercicio.nome } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { grupo_muscular: @exercicio.grupo_muscular, instrucoes: @exercicio.instrucoes, nome: @exercicio.nome } }
